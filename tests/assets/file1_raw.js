...
(function (om) {
    ...
    (function (data) {
         ...
         */
        var SingletonContainer = /** @class */ (function () {
            ...
            SingletonContainer.prototype.register = function (type, errorIfRegistered) {
                if (errorIfRegistered === void 0) { errorIfRegistered = false; }
                var key = this._getKey(type);
                if (!(key in this._dictionary)) {
...
(function (om) {
    ...
    (function (mlp) {
         ...
         * ```
         */
        var MultiLayerPerceptron = /** @class */ (function () {
            ...
            Object.defineProperty(MultiLayerPerceptron.prototype, "learningRate", {
                 ...
                 */
                get: function () { return this._momentum; },
                enumerable: true,
                configurable: true
            });
            MultiLayerPerceptron.prototype.asyncExecute = function (callback) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this._createExecutePromise(input)];
                            case 1:
                                result = _a.sent();
                                callback(result);
                                return [2 /*return*/];
            ...
            MultiLayerPerceptron.prototype.asyncTrain = function (callback) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(this._state !== om.TrainingState.Completed)) return [3 /*break*/, 2];
                                return [4 /*yield*/, this._createTrainingPromise(dataSet)];
                            case 1:
                                _a.sent();
...
//# sourceMappingURL=file1_raw.js.map
